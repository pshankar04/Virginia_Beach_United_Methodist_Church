...
// if (!passionWindow || passionWindow.closed) {
        
//  passionWindow = window.open('','sub','height=600,width=1000,left=150,top=70,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes');

//  setTimeout("writeToPassionWindow", 50);
        
//     } else if (passionWindow.focus) {
//         passionWindow.focus(); /* means window is already open*/
//     }
...
function writeToWindow() {
    ...
    var newContent = "<html><head><title>Spiritual Gifts</title></head>";
...
{
  alert("Hello");
  var link = "mailto:puneeth.bikks@gmail.com"+
             "?cc=pbikk001@odu.edu"+
