...
//echo "sent";
      ...
      $mail->Username = 'puneeth.bikks@gmail.com';
      $mail->Password = 'dream@87';
      $mail->SMTPSecure= 'tls';
      ...
      $mail->setFrom('puneeth.bikks@gmail.com',"Assessment");
      $mail->AddAddress($emailId);     // Add a recipient
      $mail->AddCC("puneeth.shankar87@gmail.com");
       
      // Optional name
      $mail->isHTML(true);                                  // Set email format to HTML

      $mail->Subject = 'Spiritual Assessment - Virginia Beach United Methodist Church';
      $mail->Body    = $message;
