...
// alert("You have won :"+" \n " +" \n " + realGift[0] + " \n " + realGift[1] + " \n " + realGift[2]);
 if (!newWindow || newWindow.closed) {
         newWindow = window.open('','sub','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=yes, width=900, height=600');
      
         setTimeout("writeToWindow()", 50);
         /* wait a bit to give time for the window to be created */
...
function writeToWindow() {
 ...
 <!-- <form id="quiz" name="quiz" action="" method="POST" onsubmit='getScore();'> -->
